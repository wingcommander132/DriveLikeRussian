...
{
   public static readonly string MicroSplatVersion = "1.8";
   ...
   void InitModules()
   {
      if (modules.Count == 0)
      {
         ...
         modules.Add(new Module("https://www.assetstore.unity3d.com/#!/content/105627?aid=1011l37NJ&pubref=1011l37NJ", "microsplat_module_windglitter"));
			...
			modules.Add(new Module("https://www.assetstore.unity3d.com/#!/content/108321", "microsplat_module_advanceddetails"));
			#endif
